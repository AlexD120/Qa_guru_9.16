...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "Safari", marks=[pytest.mark.xfail(reason="TASK-123 Safari problem")]
        ),
    ],
)
...
user1 = User(id=1, name='Alexander', age=31, description='worker')
user2 = User(id=2, name='Alia', age=22, description='administrator')
